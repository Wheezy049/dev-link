   ...
   const handleLogIn = async (e: React.FormEvent) =>{
    ...
    return (
      <div className="flex flex-col justify-center h-screen w-full items-center m-auto">
        ...
        <form onSubmit={handleLogIn} className="w-[311px] md:w-[476px] h-auto p-8 md:p-10 bg-white border border-[#D9D9D9]">
          <h1 className="text-[#333] text-2xl md:text-3xl mb-2">Login</h1>
          <p className="text-[#333] text-base mb-10">Add your details below to get back into the app</p>
          <div>
          ...
          <button type="submit" className="w-full h-12 rounded-lg flex justify-center py-3 bg-[#633CFF] text-white text-base font-semibold mb-6 cursor-pointer">Login</button>
          <div className="flex flex-col md:flex-row gap-1 text-base justify-center items-center">
            ...
            <a href="/signUp" className="text-[#633CFF]">Create account</a>
          </div>
        </form>
      </div>
    );
