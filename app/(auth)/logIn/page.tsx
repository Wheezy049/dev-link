...
export default function LogIn() {
  ...
  return (
    <div className="flex flex-col justify-center h-screen w-full items-center m-auto">
      ...
      <form
        ...
        className="w-[311px] md:w-[476px] h-auto p-8 md:p-10 bg-white border border-[#D9D9D9]"
      >
        <h1 className="text-[#333] text-2xl md:text-3xl mb-2">Login</h1>
        <p className="text-[#333] text-base mb-10">
        ...
        <div>
          ...
          <div                 tabIndex={0}
                onBlur={handleBlur}
                onFocus={handleFocus} className={`flex mb-6 gap-2 px-4 py-3 w-full h-12 items-center bg-white border border-[#D9D9D9] rounded-lg ${isFocused ? 'focus:border-[#633CFF] focus:ring-1 focus:ring-[#633CFF]' : ''}`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div>
          <label className="mb-1 text-[#333] text-sm">Password</label>
        ...
        <button
          type="submit"
          className="w-full h-12 rounded-lg flex justify-center py-3 bg-[#633CFF] text-white text-base font-semibold mb-6 cursor-pointer"
        >
          Login
        </button>
        <div className="flex flex-col md:flex-row gap-1 text-base justify-center items-center">
          <p className="text-[#333]">Don&apos;t have an account?</p>
          <a href="/signUp" className="text-[#633CFF]">
            Create account
          </a>
        </div>
      </form>
